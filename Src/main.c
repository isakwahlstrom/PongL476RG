...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_Pin|LED2_Pin|LED3_Pin|LED4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : L_Butt_Pin */
  GPIO_InitStruct.Pin = L_Butt_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(L_Butt_GPIO_Port, &GPIO_InitStruct);
